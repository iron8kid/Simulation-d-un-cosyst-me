...
main : main.cpp Aquarium.o Bestiole.o Milieu.o Comportement.o Gregaire.o Kamikaze.o Peureuse.o Prevoyante.o  MultiComportement.o VisiteurDeplacement.o Camouflage.o Carapace.o Nageoire.o Oeil.o Oreille.o
	g++ $(CPP_FLAGS) -o main main.cpp Aquarium.o Bestiole.o Milieu.o Comportement.o Gregaire.o Kamikaze.o Peureuse.o Prevoyante.o MultiComportement.o VisiteurDeplacement.o Camouflage.o Carapace.o Nageoire.o Oeil.o Oreille.o -I . -lX11 -lpthread
...
MultiComportement.o : Comportements/MultiComportement.h Comportements/MultiComportement.cpp Comportements/Comportement.h Visiteur.h
	g++ $(CPP_FLAGS) -c Comportements/MultiComportement.cpp -I .
